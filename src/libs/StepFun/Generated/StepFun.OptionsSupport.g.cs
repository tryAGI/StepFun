...
namespace StepFun
{
    ...
    public sealed class AutoSDKClientOptions
    {
        ...
        /// </summary>
        public global::StepFun.AutoSDKRetryOptions Retry { get; set; } = new global::StepFun.AutoSDKRetryOptions();
        ...
        /// </summary>
        public global::System.Collections.Generic.List<global::StepFun.IAutoSDKHook> Hooks { get; } =
            new global::System.Collections.Generic.List<global::StepFun.IAutoSDKHook>();
        ...
        public global::StepFun.AutoSDKClientOptions AddHook(
            global::StepFun.IAutoSDKHook hook)
        {
        ...
        /// </summary>
        public global::StepFun.IAutoSDKAuthorizationProvider? AuthorizationProvider { get; set; }
        ...
        public global::StepFun.AutoSDKClientOptions UseAuthorizationProvider(
            global::StepFun.IAutoSDKAuthorizationProvider provider)
        {
            AuthorizationProvider = provider ?? throw new global::System.ArgumentNullException(nameof(provider));
            if (Hooks.Find(static x => x is global::StepFun.AutoSDKAuthorizationProviderHook) == null)
            {
                Hooks.Add(new global::StepFun.AutoSDKAuthorizationProviderHook());
            }
    ...
    public readonly struct AutoSDKAuthorizationValue
    {
        ...
        public static global::StepFun.AutoSDKAuthorizationValue Bearer(string token) => new(value: token, scheme: "Bearer");

        /// <summary>Convenience factory for an API-key header.</summary>
        public static global::StepFun.AutoSDKAuthorizationValue ApiKeyHeader(string name, string value) =>
    ...
    public interface IAutoSDKAuthorizationProvider
    {
        ...
        global::System.Threading.Tasks.Task<global::System.Collections.Generic.IReadOnlyList<global::StepFun.AutoSDKAuthorizationValue>?> ResolveAsync(
            global::StepFun.AutoSDKHookContext context);
    }
...
#pragma warning restore CS0618
    ...
    /// </summary>
    public sealed class AutoSDKAuthorizationProviderHook : global::StepFun.AutoSDKHook
    {
        /// <inheritdoc />
            ...
            global::StepFun.AutoSDKHookContext context)
        {
            ...
            if (perRequest != null && perRequest.Count > 0)
            {
                ...
                global::StepFun.AutoSDKHttpRequestOptions.StampAuthorizationOverride(context.Request);
                return;
            }
        ...
        private static void ApplyAuthorization(
            global::System.Net.Http.HttpRequestMessage request,
            global::StepFun.AutoSDKAuthorizationValue authorization)
        {
    ...
    public sealed class AutoSDKRequestOptions
    {
        ...
        /// </summary>
        public global::StepFun.AutoSDKRetryOptions? Retry { get; set; }
        ...
        /// </summary>
        public global::System.Collections.Generic.IReadOnlyList<global::StepFun.AutoSDKAuthorizationValue>? Authorizations { get; set; }
    }
    ...
    /// </summary>
    public abstract class AutoSDKHook : global::StepFun.IAutoSDKHook
    {
        /// <inheritdoc />
    ...
    public sealed class AutoSDKHookContext
    {
        ...
        /// </summary>
        public global::StepFun.AutoSDKClientOptions ClientOptions { get; set; } = null!;

        /// <summary>
        /// The per-request runtime options.
        /// </summary>
        public global::StepFun.AutoSDKRequestOptions? RequestOptions { get; set; }
    ...
    {
        internal static global::StepFun.AutoSDKHookContext CreateHookContext(
            string operationId,
            string methodName,
            string pathTemplate,
            string httpMethod,
            ...
            global::StepFun.AutoSDKClientOptions clientOptions,
            global::StepFun.AutoSDKRequestOptions? requestOptions,
            int attempt,
            int maxAttempts,
            bool willRetry,
        ...
        {
            return new global::StepFun.AutoSDKHookContext
            {
        ...
        internal static global::System.TimeSpan GetRetryDelay(
            ...
            int attempt)
        {
            var retryOptions = requestOptions?.Retry ?? clientOptions.Retry ?? new global::StepFun.AutoSDKRetryOptions();
        ...
        private static global::System.TimeSpan ClampRetryDelay(
            global::System.TimeSpan delay,
            global::StepFun.AutoSDKRetryOptions retryOptions)
        {
        ...
        private static async global::System.Threading.Tasks.Task InvokeHooksAsync(
            global::StepFun.AutoSDKClientOptions clientOptions,
            global::System.Func<global::StepFun.IAutoSDKHook, global::StepFun.AutoSDKHookContext, global::System.Threading.Tasks.Task> callback,
            global::StepFun.AutoSDKHookContext context)
        {
