...
The StepFun SDK provides integration with [Microsoft.Extensions.AI](https://learn.microsoft.com/en-us/dotnet/ai/microsoft-extensions-ai), enabling seamless interoperability with the unified .NET AI abstractions.

## Installation

```bash
dotnet add package StepFun
```
...
using var client = new StepFunClient(
    apiKey: Environment.GetEnvironmentVariable("STEPFUN_API_KEY")!);
